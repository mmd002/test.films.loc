...
<!-- <div class="control">
  ...
  <input id="range" type="range" max="100" min="0" value="50">
  </div>
   <button id="btn" value="0">button</button>
  <input type="range" value="50" max="50" min="0" step="10" id="controlRange">
</div> -->
<div id="page" class="container-16 clearfix">
  <div id="site-header" class="clearfix">
         <div id="branding" class="grid-1 clearfix">
  ...
  <?php if ($page['highlighted']): ?>
    <div id="highlighted" class="<?php print ns('grid-16', $page['header'], 7); ?>">
