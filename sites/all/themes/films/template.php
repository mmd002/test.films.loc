...
function films_preprocess_html(&$vars) {
  drupal_add_css('https://s3-us-west-2.amazonaws.com/film.loc/css/reset.css', array('group' => CSS_THEME, 'type' => 'external'));
  drupal_add_css('https://s3-us-west-2.amazonaws.com/film.loc/css/text.css', array('group' => CSS_THEME, 'type' => 'external'));
  drupal_add_css('https://s3-us-west-2.amazonaws.com/film.loc/css/960.css', array('group' => CSS_THEME, 'type' => 'external'));
  drupal_add_css('https://s3-us-west-2.amazonaws.com/film.loc/css/styles.css', array('group' => CSS_THEME, 'type' => 'external'));
  drupal_add_js('https://s3-us-west-2.amazonaws.com/film.loc/js/SayHi.js', array('type' => 'external', 'scope' => 'header', 'weight' => 10));
  //drupal_add_js('https://s3-us-west-2.amazonaws.com/film.loc/js/SayHi.js');
 ...
 */
function films_preprocess_page(&$vars, $hook) {
  drupal_add_css('https://s3-us-west-2.amazonaws.com/film.loc/css/styles.css');
  $vargs = array(
      'text' => 'My Link Text',
      'path' => 'simple-dialog-example/target-page',
      'selector' => 'load-this-element',
      'title' => 'My Dialog Titlefsfsfsfs',
      'options' => array(
        'width' => 900,
        'resizable' => FALSE,
...
function films_form_alter(&$form, &$form_state, $form_id) {
  if ($form_id == 'search_block_form') {
    $form['search_block_form']['#attributes']['placeholder'] = t('Site search');
  }
   if ($form_id == 'comment_node_film_form') {
